...
<body>
    <header class="tm-header">
        <nav class="tm-nav">
            <div>
                <ul>
                    <li class="tm-list"><a id="navHome" href="home">Home</a></li>
    ...
    <section class="tm-imgslider">
        ...
        <div class="slider single">
            <div>
                <div class="tm-slider"><img class="tm-sliderimage" src="<?php echo ASSETS; ?>/images/main_slider11.png" alt="Majestic Hotel">
            ...
            <div>
                <div class="tm-slider"><img class="tm-sliderimage" src="<?php echo ASSETS; ?>/images/main_slider12.png" alt="Majestic Hotel">
                    <div class="tm-slidertext">
                        <p class="bold"> Expierence</p>
            ...
            <div>
                <div class="tm-slider"><img class="tm-sliderimage" src="<?php echo ASSETS; ?>/images/main_slider13.png" alt="Majestic Hotel">
                    <div class="tm-slidertext">
                        <p class="bold"> Expierence</p>
            ...
            <div>
                <div class="tm-slider"><img class="tm-sliderimage" src="<?php echo ASSETS; ?>/images/main_slider14.png" alt="Majestic Hotel">
                    <div class="tm-slidertext">
        ...
        <img src="<?php echo ASSETS; ?>/images/back.png" class="left">
        <img src="<?php echo ASSETS; ?>/images/next.png" class="right">
    </section>
    ...
    <section class="slider room flex">
        ...
        <div class="tm-rooms">
            <img src="<?php echo ASSETS; ?>/images/luxury.png">
            <a href="rooms.html">
        ...
        <div class="tm-rooms">
            <img src="<?php echo ASSETS; ?>/images/delux.png">
            <a href="rooms.html">
        ...
        <div class="tm-rooms">
            <img src="<?php echo ASSETS; ?>/images/premier.png">
            <a href="rooms.html">
                <p>Premier Suite</p>
            </a>
        ...
        <div class="tm-rooms">
            <img src="<?php echo ASSETS; ?>/images/luxuryroom.png">
            <a href="rooms.html">
        ...
        <div class="tm-rooms">
            <img src="<?php echo ASSETS; ?>/images/deluxroom.png">
            <a href="rooms.html">
                <p>Delux Room</p>
            </a>
        ...
        <div class="tm-rooms">
            <img src="<?php echo ASSETS; ?>/images/premiumroom.png">
            <a href="rooms.html">
                <p>Premier Room</p>
            </a>
